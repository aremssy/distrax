...
class AdminMenu
{
    ...
    public static function items(): array
    {
        return [
            ...
            ['label' => 'Verification Cases', 'route' => 'admin.verification-cases.index', 'permission' => 'verification_cases.view', 'icon' => 'shield-check'],
            ['divider' => true, 'label' => 'Deals & Legal'],
            ['label' => 'Deals',          'route' => 'admin.deals.index',           'permission' => 'deals.view',         'icon' => 'hand-coins'],
            ['label' => 'Legal Matters',  'route' => 'admin.legal-matters.index',   'permission' => 'legal_matters.view', 'icon' => 'scale'],
