...
class StoreAgencyRequest extends FormRequest
{
    ...
    {
        return [
            'owner_email.required' => 'Please enter the email address of the user who will own this agency.',
            'owner_email.email' => 'Please enter a valid owner email, like name@example.com.',
            'owner_email.exists' => 'No registered user was found with that email address.',
