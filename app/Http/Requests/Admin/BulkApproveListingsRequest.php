...
class BulkApproveListingsRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'ids.required' => 'Please select at least one listing to approve.',
            'ids.array' => 'The listing selection is invalid. Please select the listings again.',
            'ids.max' => 'You can only approve up to 100 listings at a time.',
