                        ...
                        <div class="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-3">
                            ...
                            @if ($marketValue)
                                <div class="rounded-xl bg-slate-50 px-4 py-3">
                                    ...
                                    <p class="text-lg font-bold text-slate-950">{{ moneyFrom($marketValue, $valuation?->currency_code ?? $listing->currency_code, baseCurrencyCode()) }}</p>
                                </div>
                            @endif
                            @if ($discountPct !== null)
                    ...
                    <section id="deal-analysis" class="scroll-mt-32 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-7">
                        ...
                        <dl class="mt-5 grid grid-cols-2 gap-3 text-sm sm:grid-cols-3">
                            ...
                            <div class="rounded-xl bg-slate-50 px-4 py-3">
                                ...
                                <dd class="mt-1 font-bold text-slate-950">{{ $marketValue ? moneyFrom($marketValue, $valuation?->currency_code ?? $listing->currency_code, baseCurrencyCode()) : __('Not available') }}</dd>
                            </div>
                            <div class="rounded-xl bg-slate-50 px-4 py-3">
